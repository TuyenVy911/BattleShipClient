...
class ClientGame {
	...
	{
		username = CreateName();
		System.out.println("Họ và tên của bạn là: "+username);
		IO.sendMessage(username+":join");
		if(IO.getMessage().equals("Server đã đầy"))
		{
			System.out.println("Server đã đầy, thử lại sau");
			System.exit(0);
		}
		else
		{
	...
	private String CreateName()
	{
		while(true)
		{
			...
			{
				System.err.println("Error: Không đúng cú pháp");
			}
		}
	}
	...
	private String getLine()
	{
		...
		while(true)
		{
			try
			{
				System.out.println("Nhập một ký tự và một chữ số liền nhau");
				command = inFromUser.readLine();
			}
			catch(IOException e)
			{
				System.err.println("Error: Nhập không đúng cú pháp");
			}
			if(command.matches("[a-jA-J]{1}[0-9]{1}"))
			{
				return command.toLowerCase();
			}
			System.out.println("Thử lại ngay!");
		}
	}
	...
	private String getShips()
	{
		...
		System.out.println("Vị trí mà bạn định đặt tàu");
		...
		{		
			...
			{
				case 0:
					System.out.println("Đặt vị trí cho Tàu sân bay(5)!"); length = 5; break;
				case 1:
					System.out.println("Đặt vị trí cho Thiết giáp hạm(4)!"); length = 4; break;
				case 2:
					System.out.println("Đặt vị trí cho Khu trục hạm(3)!"); length = 3; break;
				case 3:
					System.out.println("Đặt vị trí cho Tàu ngầm(3)!"); length = 3; break;
				case 4:
					System.out.println("Đặt vị trí cho Hộ vệ hạm(2)!"); length = 2; break;
			}
			DisplayShips(board);
			System.out.println("Nhập vào vị trí đầu tiên định đặt tàu");
			...
			System.out.println("Nhập vào vị trí cuối cùng định đặt tàu");
